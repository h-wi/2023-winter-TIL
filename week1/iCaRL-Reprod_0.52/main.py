...
def get_args_parser():
    ...
    parser.add_argument('--decay-epochs', default=[], metavar='LR',
                        help='learning milestones')
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='./datas', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--output-dir', default='',
                        help='Dont use that')
    parser.add_argument('--output-basedir', default='./outputs/',
